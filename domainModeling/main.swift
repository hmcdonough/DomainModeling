...
class Job: CustomStringConvertible {
    ...
    var description: String {
        ...
        return title + " " + salary.description + " is per hour:" + String(isPerHour)
    }
...
class Person: CustomStringConvertible {
    ...
    var description: String {
        var spouseInfo = ""
        if spouse != nil {
            spouseInfo += spouse!.firstName + spouse!.lastName + String(spouse!.age) + (spouse!.job != nil ? spouse!.job!.description : "")
        }
        return firstName + lastName + String(age) + (job != nil ? job!.description + " " : "") + spouseInfo
    }
...
class Family: CustomStringConvertible {
    ...
    var description: String {
        var familyInfo = String(householdIncome()) + "|"
